...
let ar1 = ['qwerty', 4.25, 8, 23, true, 'asdf', false];
...
let ar2 = [42, 123, 'яблоко', true, 'банан'];
...
let ar3 = ['banana', 'orange', 'apple', 'mango'];
...
let ar4 = [45, 98, 32, 65, 72, 3, 41, 8, 12, 37, 29];
...
let ar5 = [45, 98, 32, 65, 72, 3, 41, 8, 12, 37, 29];
...
let ar6 = ['михаил', 'лев', 30, 'июль'];
let out6 = document.querySelector('.out-6');

function f6() {
  let out = '';

  for (let i = 0; i <= ar6.length - 1; i++) {
    out += ar6[i] + ' ';
  }
...
function f12() {
  ...
  ar12[ar12.length - 1] = s;

  let out = '';

  for (let i = 0; i <= ar12.length - 1; i++) {
    out += ar12[i] + ' ';
  }
...
function f16() {
  ...
  out16_odd.innerHTML = out_odd;
  out16_even.innerHTML = out_even;
}
